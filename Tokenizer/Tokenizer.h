 ...
 *						-- gets the tokens
 *		++ bool canRead() :
 *						-- checks if read can be performed
 ...
 *						-- Enables to change defaults of Single Special Character tokens
 *		++ void setSpecialCharPairs(std::string scp) :
 *						-- Enables to change defaults of Double Special Character tokens
 *
 * Build Process:
 * --------------
