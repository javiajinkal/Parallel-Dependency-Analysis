...
/*
  ...
  element elem;
  stack.push(elem); //pushes elem on stack
  element popped = stack.pop(); // pops elem from stack top
  element top_elem = stack.top(); //returns top element of the stack
  size_t s = stack.size(); // returns size of the stack
